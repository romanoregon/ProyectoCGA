...
//audio en modo mono| programa audacity | 
...
int ch;
ALboolean loop;
std::vector<bool> sourcePlay = {true, true, true};
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	alSourcef(source[2],AL_GAIN, 0.1f);//cambiar la intencidad
...
void applicationLoop() {
	...
	modelMatrixMain = glm::translate(modelMatrixMain, glm::vec3(-13.0f, 0.05f, -5.0f));
	modelMatrixMain = glm::rotate(modelMatrixMain, glm::radians(-90.0f), glm::vec3(0, 1, 0));

	modelMatrixMain1 = glm::translate(modelMatrixMain1, glm::vec3(-13.0f, 0.05f, -20.0f));
	modelMatrixMain1 = glm::rotate(modelMatrixMain1, glm::radians(-90.0f), glm::vec3(0, 1, 0));

	modelMatrixMain2 = glm::translate(modelMatrixMain2, glm::vec3(-13.0f, 0.05f, 20.0f));
	modelMatrixMain2 = glm::rotate(modelMatrixMain2, glm::radians(-90.0f), glm::vec3(0, 1, 0));

	modelMatrixZombie = glm::translate(modelMatrixZombie, glm::vec3(-20.0f, 0.05f, -10.0f));
...
*/
		...
		for(unsigned int i=0; i < sourcePlay.size(); i++){
			if(sourcePlay[i]){
